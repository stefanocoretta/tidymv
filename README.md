...
To install the package, use `devtools::install_github("stefanocoretta/tidymv@v1.2.0", build_vignettes = TRUE)`. To learn how to use the package, do `vignette("plot-gamms", package = "tidymv")` after the installation.
